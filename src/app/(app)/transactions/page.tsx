...
export default async function TransactionsPage({
  ...
  searchParams: Promise<{ q?: string; tab?: string; month?: string; category?: string; p?: string; from?: string; to?: string }>;
}) {
  ...
  const [initialPage, category] = await Promise.all([
    queryTransactions(user.id, { type, monthKey: params.month, categoryId, period, textQuery: params.q }, 0),
